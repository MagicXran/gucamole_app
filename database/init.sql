...
CREATE TABLE IF NOT EXISTS remote_app (
    ...
    launch_preset   VARCHAR(50)   NOT NULL DEFAULT 'custom' COMMENT '启动预设',
    server_file_path VARCHAR(500) DEFAULT NULL         COMMENT '服务器端固定文件路径',
    launch_arg_template VARCHAR(500) DEFAULT NULL      COMMENT '启动参数模板',
